...
# KiCad 10
docker pull ghcr.io/inti-cmnb/kicad_auto_test:ki10
docker tag ghcr.io/inti-cmnb/kicad_auto_test:ki10 setsoft/kicad_auto_test:ki10
docker tag ghcr.io/inti-cmnb/kicad_auto_test:ki10 ghcr.io/inti-cmnb/kicad10_auto_full:latest
